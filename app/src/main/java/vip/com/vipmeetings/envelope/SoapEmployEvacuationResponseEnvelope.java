...
public class SoapEmployEvacuationResponseEnvelope {

    @Element(name = "Body", required = false)
    private EvacuationEmployResponseBody body;

    public EvacuationEmployResponseBody getBody() {
        return body;
    }

    public void setBody(EvacuationEmployResponseBody body) {
        this.body = body;
    }
}
