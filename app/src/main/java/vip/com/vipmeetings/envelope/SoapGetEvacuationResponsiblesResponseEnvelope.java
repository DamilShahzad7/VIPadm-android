...
public class SoapGetEvacuationResponsiblesResponseEnvelope {

    @Element(name = "Body", required = false)
    private GetResponsibleResponseBody body;

    public GetResponsibleResponseBody getBody() {
        return body;
    }

    public void setBody(GetResponsibleResponseBody body) {
        this.body = body;
    }
}
