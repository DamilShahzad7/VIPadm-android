...
public class SoapGetEvacuationsResponseEnvelope {

    @Element(name = "Body", required = false)
    private GetEvacuationsResponseBody body;

    public GetEvacuationsResponseBody getBody() {
        return body;
    }

    public void setBody(GetEvacuationsResponseBody body) {
        this.body = body;
    }
}
