...
public class SeperatorDecoration2 extends RecyclerView.ItemDecoration {
     ...
     */
    public SeperatorDecoration2(@NonNull Context context, @ColorInt int color,
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (position < state.getItemCount()) {
                c.drawLine(view.getLeft() + thickness, view.getBottom() + offset,
                        view.getRight() + thickness, view.getBottom() + offset, mPaint);
            }
        }
    }
}