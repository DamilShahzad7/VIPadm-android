...
public class EmployResponseBody {
    ...
    private AuthenticateLoginResponse authenticateLoginResponse;

    public AuthenticateLoginResponse getAuthenticateLoginResponse() {
        return authenticateLoginResponse;
    }

    public void setAuthenticateLoginResponse(AuthenticateLoginResponse authenticateLoginResponse) {
